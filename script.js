...
// Promises.resolve('Resolve promise 1').then(res=> console.log(res));
// Promises.resolve('Resolve promise 2').then(res=>{
...
//     currentImg=img;
//     return wait(2);
// }).then(()=>currentImg.style.dislay='none').catch(err=>console.error(err));
...
Promise.all([Promise.resolve('Success'),Promise.reject('ERROR'),Promise.resolve('Another success')]).then(res=>console.log(res)).catch(err=>console.error(err));
...
const wait = function (seconds) {
  ...
  createImage('img/img-1.jpg')
    ...
    const loadNPause=async function(){
        try{
            //load image 1
            const img= await createImage('img/img-1.png');
            console.log('Image 1 loaded');
            await wait(2);
